...
function Program4() {
  ...
  return (
    <div className="ece-container">
      <img src="/i4.jpg" alt="program4" className="image" />
      ...
      {showDetails && (
        <div>
          <p>
            English language teaching in schools often focuses on one strand,
            with mainstream schools using NCERT textbooks without teaching
            ...
            sprinkled with some phonics activities and decodables. These
            programs often avoid exposure to other texts and stories, making
            children less likely to retain the code. While some non-profit
            organizations and innovative schools adopt a whole language-based
            approach, incorporating lived experiences and writing work but
            failing to include systematic decoding. This can lead to children
            developing sight reading and oral language skills but falling behind
            as the cognitive burden increases with grades.
          </p>
          <p>
            ...
            development of the child’s oral language, while building
            orthographic expertise, and providing adequate exposure to real
            texts, all three serving as parallel strands of a wholesome language
            curriculum that incorporates the realities and challenges of
            resources and time.
          </p>
          <p style={{ fontWeight: 600 }}>
            We partner with like-minded NGOs and schools, and offer programs
            that complement and build on the existing teaching of the school and
            NGOs. IMLI EDUCATION, has provided technical support to schools and
            NGOs through trainings and courses to help improve children’s

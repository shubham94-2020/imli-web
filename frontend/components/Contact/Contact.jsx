    ...
    <>
      <div className="upperMain">
        ...
        <div className="corporate">
          <div>
            ...
            <p>
              We welcome long term relationships to impact students learning in
      ...
      <div className="contact-us-container">
        <div className="contact-us-text">
          ...
          <p>
            Would you like to collaborate with us or learn about our work? We
            are always open for collaborating on innovative projects! Send us an
            email and we’ll be sure to get back to you.
          </p>
          <p>
            Reach us at{" "}
            <a href="imli.education@gmail.com">
              ...
              <div className="reg">
                ...
                <div className="details">
                  ...
                  <span className="text-body">
                    ...
                    Housing Society, 3rd Floor, Pune-Bangalore Highway,

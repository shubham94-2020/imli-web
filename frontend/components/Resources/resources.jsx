...
>>>>>>> 86b18145b85aca319a2404453d076713bf40b603
...
<br />
        ...
        {selectedOption === 'teacherEducator' && (
          ...
          <div className="dropdown-container">
            <button className="dropdown1"
            onClick={toggleDropdown1}>Assessment</button>
            {showDropdown1 && (
              <div
                className="dropdown-content1"
              >
            ...
            <button className="dropdown2"
            onClick={toggleDropdown2}>Classroom</button>
            {showDropdown2 && (
              <div
                className="dropdown-content2"
              >
            ...
            <button className="dropdown3"
            onClick={toggleDropdown3}>Development</button>
            {showDropdown3 && (
              <div
                className="dropdown-content3"
              >

    ...
    <>
      <div className="about-imli-container">
        ...
        <p>
          ...
          resource organizations to create and translate free learning resources
          for tribal children.
        </p>
        <p>
          While we continued to engage with local and tribal language resource
          building, we saw that many students needed support in English, and the
          current teaching pedagogies across many schools were not implementing
          a science-backed approach to teaching English.
        </p>
        <p>
          ...
          to become different kind of learners. We sought to bring enquiry-based
          approaches and socio-emotional learning of Empathy, Mindfulness,
          Compassion, and Critical Inquiry to children to help them adapt and
          succeed.
        </p>
        <p>
        ...
        <ul>
          <li>
            ...
            <p>
              Children need to have strong foundations in language to be able to
              express themselves and engage fully with learning across all other
              subjects. Whether it be STEM or 21st Century skills, strong
              language abilities open doors to better learning.
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              learning in his mother tongue or in English, he should have access
              to the best resources for learning it.
            </p>
          </li>
          <li>
      ...
      <div className="vision">
        <h2>Our Vision</h2>
        <p>
          To support and strengthen positive learning environments for children,
          that engender empathy in <br /> children to create a world of where
          pluralistic democratic communities coexist in harmony.
        </p>
      </div>
      <div className="vision">
        <h2>Our Mission</h2>
        <ul>
          <li>
            Impact language learning for 10,000 children by 2028 across English
